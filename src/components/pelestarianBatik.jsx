...
function PelestarianBatik() {
  ...
  useEffect(() => {
    fetchData('http://localhost:5000/api/pelestarian')
      .then(data => {
        setPelestarian(data);
      })
      .catch(error => {
      ...
      <section id="landing" className="relative">
        <div className="landing-container">
          <div className="landing-center relative">
            <img src={`http://localhost:5000/images/${pelestarian[0].image}`} alt="landing" className="w-full h-screen object-cover" />
